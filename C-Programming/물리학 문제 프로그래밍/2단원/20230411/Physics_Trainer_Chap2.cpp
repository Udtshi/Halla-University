...
void Excersize_2_19(int solution, int answer)
{
	...
	if (solution == SHOW)
	{
		...
		printf("=================================================================\n");
		// your code here
		printf("(a) 문제를 풀기 앞서 먼저 혼합된 가속도를 정리해야 합니다. \n");
		printf("km/h/s를 m/s로 변환하세요.\n\n");

		printf("a = %.lf km/h/s = %.lf km/h/s * 1000m/1km * 1h/3600s * 1/s = %.2lf m/s^2\n\n", acceleration, acceleration, converted_acceleration);

		printf("과속 운전자가 t시간 동안 달린 거리는 다음과 같습니다. (X1): \n");
		printf("X1 = V0t + 1/2 * a * t^2 = %.1lf m\n\n ", velocity / 3.6);

		printf("경찰차가 t시간 동안 달린 거리는 다음과 같습니다. (X2): \n");
	...
	if (solution == SHOW)
	{
		printf("\n\n\n");
		printf("=================================================================\n");
		printf("거리를 알기 위해서는 V^2 - V0^2 = 2as 공식을 사용해야 합니다.\n");
...
void Excersize_2_23(int solution, int answer)
{
	...
	if (solution == SHOW)
	{
		...
		printf("관련 공식은 등가속도 운동 공식입니다.\n");
		printf("관련 공식은 Y = V01T + 2/1* AT^2 입니다.\n");



		printf("처음으로는 V1을 구합니다.\n\n");
	...
	if (solution == SHOW)
	{
		printf("\n\n\n");
		printf("=================================================================\n");
		printf("(b) Y의 값은 얼마인가요 ? \n\n");
		printf("관련 공식은 V^2 - V02 = 2aY\n");
		printf("Y를 구합니다\n\n");
